...
search.culpur.net verfügt über eine Syntax mit der in einer Suchanfrage die Kategorien,
...
search.culpur.net unterstützt die _external bangs_ von [ddg].  Das Präfix `!!` kann
...
search.culpur.net kann die Privatsphäre des Benutzers in diesem Fall nur eingeschränkt
